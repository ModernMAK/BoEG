//using Entity.Modules.Attackerable;
//using Entity.Modules.Magicable;
//using Entity.Modules.Movable;
...
//                var props = GetProperties(property);
//
//                position = DrawerUtil.DisplayBaseGain(position, props[0], props[1], new GUIContent("AttackDamage")); //3
