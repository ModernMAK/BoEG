...
//                position = DrawerUtil.DisplayBaseGain(position, props[2], props[3], new GUIContent("Resisted")); //3
...
//                    new GUIContent("Magical Resisted")); //3
...
//    }
//}
//////[CustomPropertyDrawer(typeof(HealthableAsset))]
...
//////}
////
////[CustomEditor(typeof(HealthableAsset))]
